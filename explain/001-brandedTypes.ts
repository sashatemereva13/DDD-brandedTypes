...
// TODO:  1. create makePrice and makeQuantity functions
// that validate the inputs and return branded types instead of raw numbers.
...
console.log(makePrice(10)); // Valid price
...
console.log(makeQuantity(3)); // Valid quantity



// TODO:  2. update calculatePrice to accept only resutls 
// from makePrice and makeQuantity, 
// ensuring that invalid inputs are caught at compile time rather than runtime.

const calculatePrice = (): number => {
	const pizzaPrice = makePrice(-10)
	const pizzaCount = makeQuantity(3)

	return pizzaPrice * pizzaCount
};



// TODO:  3. apply Branded Types to calculatePrice 
// to prevent accidental misuse of the function with raw numbers, 
// enhancing type safety in the restaurant domain.
...
// TODO: 4. add try-catch blocks around the calls to makePrice and makeQuantity 
// to handle potential validation errors gracefully, 
// ensuring that the application can respond appropriately to invalid inputs without crashing.
